...
for model_id, model in enumerate(model_set):
	...
	for std_factor in range(1, 2):
		...
		ax1.plot(t_test, X_test[:,2], "ks", label = r"Data G$_2$$(t)$", alpha = 0.3, markersize = 3)
		ax1.plot(t_test, X_test[:,3], "kD", label = r"Data M$(t)$", alpha = 0.3, markersize = 3)
		# ax2.plot(t_test, X_test[:,4], "kp", label = r"Data $A(t)$", alpha = 0.3, markersize = 3)
		...
		# ax1.errorbar(t_test, X_test[:,2], yerr = std_factor*X_std[:,2], fmt = 'ks', label = r"Data G$_2$$(t)$", capsize = 2.0, alpha = 0.3, markersize = 3)
		# ax1.errorbar(t_test, X_test[:,3], yerr = std_factor*X_std[:,3], fmt = 'kD', label = r"Data M$(t)$", capsize = 2.0, alpha = 0.3, markersize = 3)
		ax2.errorbar(t_test, X_test[:,4], yerr = std_factor*X_std[:,4], fmt = 'kp', label = r"Data $A(t)$", capsize = 2.0, alpha = 0.3, markersize = 3)
		...
		ax1.plot(t_test, true_solution[:,2], "r:", label = r"True G$_2$$(t)$", alpha = 1.0, linewidth = 1)
		ax1.plot(t_test, true_solution[:,3], "m:", label = r"True M$(t)$", alpha = 1.0, linewidth = 1)
		ax2.plot(t_test, true_solution[:,4], "y:", label = r"True $A(t)$", alpha = 1.0, linewidth = 1)
		...
		ax1.plot(t_test, simulation[:,2], "r", label = r"SINDy-SA G$_2$$(t)$", alpha = 1.0, linewidth = 1)
		ax1.plot(t_test, simulation[:,3], "m", label = r"SINDy-SA M$(t)$", alpha = 1.0, linewidth = 1)
		ax2.plot(t_test, simulation[:,4], "y", label = r"SINDy-SA $A(t)$", alpha = 1.0, linewidth = 1)
		...
		ax1.set_ylabel(r"G$_0$ G$_1$$(t)$, S$(t)$, G$_2$$(t)$, M$(t)$", color = 'k')
