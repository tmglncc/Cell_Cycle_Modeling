...
X = np.delete(X, slice(45), 0)
X_std = np.delete(X_std, slice(45), 0)
t = np.delete(t, slice(45), None)
...
X_test = np.delete(X_test, slice(45), 0)
t_test = np.delete(t_test, slice(45), None)
